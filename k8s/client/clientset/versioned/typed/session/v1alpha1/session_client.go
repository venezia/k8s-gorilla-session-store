...
import (
	...
	"github.com/venezia/k8s-gorilla-session-store/k8s/client/clientset/versioned/scheme"
...
// NewForConfig creates a new GorillaV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new GorillaV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*GorillaV1alpha1Client, error) {
	...
	return &GorillaV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new GorillaV1alpha1Client for the given config and
...
func New(c rest.Interface) *GorillaV1alpha1Client {
	return &GorillaV1alpha1Client{c}
}
