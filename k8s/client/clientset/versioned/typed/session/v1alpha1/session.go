...
import (
	...
	scheme "github.com/venezia/k8s-gorilla-session-store/k8s/client/clientset/versioned/scheme"
...
func newSessions(c *GorillaV1alpha1Client, namespace string) *sessions {
	return &sessions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sessions) Apply(ctx context.Context, session *sessionv1alpha1.SessionApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Session, err error) {
	if session == nil {
...
func (c *sessions) ApplyStatus(ctx context.Context, session *sessionv1alpha1.SessionApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Session, err error) {
	if session == nil {
		return nil, fmt.Errorf("session provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
