...
// SessionApplyConfiguration represents an declarative configuration of the Session type for use
// with apply.
...
// Session constructs an declarative configuration of the Session type for use with
// apply.
func Session(name, namespace string) *SessionApplyConfiguration {
	...
	b.WithKind("Session")
	b.WithAPIVersion("gorilla.michaelvenezia.com/v1alpha1")
	return b
}
